...
```bash
cd /Users/abelferro/GitHub/welsfoundation/lp/cfm-2026
```
...
git init
git add .
git commit -m "Initial CFM 2026 landing"
```

3. Crea un repo nuevo en GitHub, por ejemplo `cfm-2026`.

4. Conecta el remoto y publica:

```bash
git remote add origin git@github.com:TU-USUARIO/cfm-2026.git
git branch -M main
...
- Para este landing, el destino recomendado es `FTP_DIR=/public_html/lp/cfm-2026/`.
- El `basePath` por defecto ya está configurado como `"/lp/cfm-2026"` en `site.config.ts`.
